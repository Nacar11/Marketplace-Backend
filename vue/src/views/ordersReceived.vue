...
<template>
    <div class="mt-6 mb-6 justify-center items-center bg-white p-4 flex"> 
        <div class="flex flex-col">
          <p class="font-semibold leading-6 text-black">Orders Received from your Product Listings</p>
          <div>
            <ul>
            <li v-for="shop_order in orders_received" :key="shop_order.id" class="mt-5 flex justify-between py-5 border-b border-gray-200">
              <div class="carousel-item h-15 w-20 overflow-hidden rounded-md border border-gray-200">
                <!-- <router-link :to="{ name: 'singleOrderReceived', params: { id: shop_order.id } }">
                <img
                @click=""
