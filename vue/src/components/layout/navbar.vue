...
// import { useProductCategoryStore } from '../../../store/product_category'
// import { onBeforeMount } from '@vue/runtime-core'
// import {computed, ref} from '@vue/reactivity'
// import { storeToRefs } from 'pinia'

// const { product_category, parent_categories } = storeToRefs(useProductCategoryStore())
// const logoutButton = async () => {
// 	await logOut()
// };

// console.log(parent_categories.subcategories)
// const { logOut } = useAuthenticateStore()
// const { test } = useProductCategoryStore()
...
//   showDropdown.value[categoryId] = !showDropdown.value[categoryId];
// }

// const hasUsernameInLocalStorage = () => {
//       return typeof localStorage !== 'undefined' && localStorage.getItem('username') !== null;
//     };
// 	const username = computed(() => {
//       return hasUsernameInLocalStorage() ? localStorage.getItem('username') : null;
//     });
</script>
